...
class TransactionController extends Controller
{
    ...
    {
        // $transact = Transaction::with('user')->get();
        // $transactdetail = TransactionDetail::with('obat', 'transaction')->get();
        $ddetail = Obat::all();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = Http::post('http://localhost:3030/notification', [
                ...
                'description' => 'Melakukan pembelian ' . Request()->jumlah_tiket . ' tiket dengan id_obat ' . Request()->obat_id,
                'user' => Auth::user()->name,
            ]);
    ...
    public function orderTiket($id)
    {
        ...
        return view('order-tiket', compact('dataobat'));
    }

    // public function tiket()
    // {
    //     $transact = Transaction::with('user')->latest()->take(1)->get();
    //     $transactdetail = TransactionDetail::with('obat', 'transaction')->latest()->take(1)->get();
